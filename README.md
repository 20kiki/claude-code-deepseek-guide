...
> 价格来源：DeepSeek 官方定价（2026 年 4 月降价后，输入 ¥3 / 输出 ¥6）；Claude Opus 4.7 官方定价（$5 / $25 per MTok，按 1 USD ≈ 7.25 CNY 换算）。DeepSeek 输出成本仅为 Claude Opus 4.7 的 **三十分之一**。
...
DeepSeek API 是**按量付费**的，用多少扣多少，不是按月订阅。最低充值 10 元，日常使用够用很久。
